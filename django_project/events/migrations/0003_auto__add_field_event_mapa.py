...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.mapa'
        db.add_column(u'events_event', 'mapa',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.mapa'
        db.delete_column(u'events_event', 'mapa')
    ...
    models = {
        u'events.event': {
            ...
            'mapa': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
