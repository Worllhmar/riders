...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.mapa'
        db.alter_column(u'events_event', 'mapa', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Event.mapa'
        db.alter_column(u'events_event', 'mapa', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        u'events.event': {
            ...
            'mapa': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
